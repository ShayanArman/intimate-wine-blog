...
<GangsterImage
  ...
  width={1500}
  height={2000}
  caption="This is what happens when a local sommelier joins the evening. What starts as a glass of wine becomes a conversation about soil, about harvest, about the family who made the bottle. Hiring a private sommelier in Italy doesn't just change what you're drinking — it changes how you experience the whole trip."
/>
...
<GangsterImage
  src="/images/blog/why-hiring-a-local-sommelier-might-be-the-best-thing-you-do-in-italy/pathway_to_heaven.jpg"
  alt="A vineyard path stretching through the Tuscan countryside"
  width={1024}
  height={768}
  caption="A hidden gem in Panzano in Chianti — the kind of place where a boutique family winery might be just down the road, unlocked only for guests who know to ask. A local sommelier knows which doors to knock on. That's the difference between a good Italian holiday and an unforgettable one."
/>
...
<GangsterImage
  src="/images/blog/why-hiring-a-local-sommelier-might-be-the-best-thing-you-do-in-italy/man_makes_magic.png"
  alt="A sommelier pouring wine during a private tasting in Italy"
  width={1366}
  height={768}
  caption="Food pairing taken seriously. When a certified sommelier selects the wine and a chef builds the dish around it — or the other way around — something aligns that you feel before you even taste it. This is what an intimate dining experience in Tuscany is really about: intention at every step."
/>
...
<GangsterImage
  src="/images/blog/why-hiring-a-local-sommelier-might-be-the-best-thing-you-do-in-italy/blonde_girl_does_things.jpg"
  alt="A woman enjoying a wine experience in Italy"
  width={3464}
  height={2309}
  caption="Ready to sip deeper into Italy? Come to Tuscany and let Intimate.Wine uncork it for you — the stories, the flavours, the Chianti you didn't know existed. Some of Italy's best moments are poured, not planned."
/>
