export const metadata = {
  ...
  thumbnail: "/images/blog/why-chianti-why-now-why-with-a-sommelier/main_header.png",
  changefreq: "monthly",
  priority: "0.8",
...
📍 Greve in Chianti | [🍷 @intimate.wine](https://www.instagram.com/intimate.wine/) | ✉️ <a href="mailto:info@intimate.wine" style={{ color: "var(--zero-orange)", fontWeight: 700 }}>info@intimate.wine</a>
