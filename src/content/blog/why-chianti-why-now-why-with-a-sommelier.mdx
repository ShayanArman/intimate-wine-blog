...
export const metadata = {
  ...
  thumbnailCaption: caption="Via Roma - the original street of Greve. Tavola Longa 2025, held once per year by a local restaurant. Open to anyone interested to attend.",
  changefreq: "monthly",
  priority: "0.8",
